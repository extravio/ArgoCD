...
argocd app create helm --repo https://github.com/extravio/ArgoCD.git --path kustomize/helm-hello-world --revision dev --dest-server https://kubernetes.default.svc --dest-namespace my-app --config-management-plugin kustomized-helm
